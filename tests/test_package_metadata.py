...
CURRENT_LAUNCHER = "GPT-5.6-Sol-Ultra_v18.0.0_SLURM.py"
...
class PackageMetadataTests(unittest.TestCase):
    def test_runtime_version_constants_are_aligned(self) -> None:
        ...
        self.assertEqual(config.SCRIPT_VERSION_COMPACT, "1800")
    ...
    def test_project_metadata_uses_mode_dispatcher(self) -> None:
        ...
        self.assertNotIn('GPT-5.6-Sol-Ultra_v17.1.5_SLURM.py', data_files)
    ...
    def test_source_distribution_has_one_versioned_launcher(self) -> None:
        ...
        self.assertNotIn("include GPT-5.6-Sol-Ultra_v17.1.5_SLURM.py", manifest_lines)
        ...
        self.assertFalse((ROOT / "GPT-5.6-Sol-Ultra_v17.1.5_SLURM.py").exists())
